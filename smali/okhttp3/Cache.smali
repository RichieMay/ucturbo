...
.method public static key(Lokhttp3/HttpUrl;)Ljava/lang/String;
    ...
    invoke-static {p0}, La/i;->a(Ljava/lang/String;)La/i;

    move-result-object p0

    invoke-virtual {p0}, La/i;->c()La/i;
...
.method static readInt(La/h;)I
    ...
    .line 726
    :try_start_0
    invoke-interface {p0}, La/h;->m()J

    move-result-wide v0

    .line 727
    invoke-interface {p0}, La/h;->q()Ljava/lang/String;
...
.method final get(Lokhttp3/Request;)Lokhttp3/Response;
    ...
    invoke-virtual {v0, v3}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;->getSource(I)La/ab;

    move-result-object v3

    invoke-direct {v2, v3}, Lokhttp3/Cache$Entry;-><init>(La/ab;)V
    :try_end_1
