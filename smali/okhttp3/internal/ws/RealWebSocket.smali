...
.method public constructor <init>(Lokhttp3/Request;Lokhttp3/WebSocketListener;Ljava/util/Random;J)V
    ...
    invoke-virtual {p1}, La/i;->b()Ljava/lang/String;
...
.method private declared-synchronized send(La/i;I)Z
    .locals 6
    ...
    invoke-direct {v1, p2, p1}, Lokhttp3/internal/ws/RealWebSocket$Message;-><init>(ILa/i;)V
...
.method final checkResponse(Lokhttp3/Response;)V
    ...
    .line 246
    invoke-virtual {v0}, La/i;->d()La/i;

    move-result-object v0

    invoke-virtual {v0}, La/i;->b()Ljava/lang/String;
...
.method final declared-synchronized close(ILjava/lang/String;J)Z
    ...
    invoke-direct {v2, p1, v0, p3, p4}, Lokhttp3/internal/ws/RealWebSocket$Close;-><init>(ILa/i;J)V
...
.method public final connect(Lokhttp3/OkHttpClient;)V
    ...
    .line 192
    invoke-interface {p1}, Lokhttp3/Call;->timeout()La/ac;

    move-result-object p1

    invoke-virtual {p1}, La/ac;->clearTimeout()La/ac;
...
.method public final initReaderAndWriter(Ljava/lang/String;Lokhttp3/internal/ws/RealWebSocket$Streams;)V
    ...
    iget-object v2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->sink:La/g;

    iget-object v3, p0, Lokhttp3/internal/ws/RealWebSocket;->random:Ljava/util/Random;

    invoke-direct {v0, v1, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;-><init>(ZLa/g;Ljava/util/Random;)V
    ...
    iget-object p2, p2, Lokhttp3/internal/ws/RealWebSocket$Streams;->source:La/h;

    invoke-direct {p1, v0, p2, p0}, Lokhttp3/internal/ws/WebSocketReader;-><init>(ZLa/h;Lokhttp3/internal/ws/WebSocketReader$FrameCallback;)V
...
.method public final onReadMessage(La/i;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {v0, p0, p1}, Lokhttp3/WebSocketListener;->onMessage(Lokhttp3/WebSocket;La/i;)V
...
.method public final declared-synchronized onReadPing(La/i;)V
    .locals 1
...
.method public final declared-synchronized onReadPong(La/i;)V
    .locals 0
...
.method final declared-synchronized pong(La/i;)Z
    .locals 1
...
.method public final send(La/i;)Z
    .locals 1
    ...
    .line 381
    invoke-direct {p0, p1, v0}, Lokhttp3/internal/ws/RealWebSocket;->send(La/i;I)Z
...
.method final writeOneFrame()Z
    ...
    .line 494
    :try_start_1
    invoke-virtual {v0, v2}, Lokhttp3/internal/ws/WebSocketWriter;->writePong(La/i;)V
    ...
    iget-object v1, v1, Lokhttp3/internal/ws/RealWebSocket$Message;->data:La/i;
    ...
    .line 498
    invoke-virtual {v0, v2, v3, v4}, Lokhttp3/internal/ws/WebSocketWriter;->newMessageSink(IJ)La/aa;
    ...
    .line 500
    invoke-interface {v0, v1}, La/g;->e(La/i;)La/g;
    ...
    iget-object v3, v3, Lokhttp3/internal/ws/RealWebSocket$Close;->reason:La/i;

    invoke-virtual {v0, v2, v3}, Lokhttp3/internal/ws/WebSocketWriter;->writeClose(ILa/i;)V
...
.method final writePingFrame()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/ws/WebSocketWriter;->writePing(La/i;)V
    :try_end_1
