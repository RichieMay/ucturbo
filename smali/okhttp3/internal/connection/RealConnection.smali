...
.field private sink:La/g;

.field private socket:Ljava/net/Socket;

.field private source:La/h;
...
.method private connectSocket(IILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    invoke-static {p1}, La/o;->b(Ljava/net/Socket;)La/ab;
    ...
    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:La/h;

    .line 260
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->rawSocket:Ljava/net/Socket;

    invoke-static {p1}, La/o;->a(Ljava/net/Socket;)La/aa;

    move-result-object p1

    invoke-static {p1}, La/o;->a(La/aa;)La/g;

    move-result-object p1

    iput-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/g;
    :try_end_1
...
.method private connectTls(Lokhttp3/internal/connection/ConnectionSpecSelector;)V
    ...
    .line 350
    invoke-static {v1}, La/o;->b(Ljava/net/Socket;)La/ab;
...
.method private connectTunnel(IIILokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 228
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/g;

    .line 229
    iput-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:La/h;
...
.method private createTunnel(IILokhttp3/Request;Lokhttp3/HttpUrl;)Lokhttp3/Request;
    ...
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:La/h;

    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/g;

    const/4 v3, 0x0

    invoke-direct {v0, v3, v3, v1, v2}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;La/h;La/g;)V

    .line 380
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->source:La/h;

    invoke-interface {v1}, La/h;->timeout()La/ac;
    ...
    invoke-virtual {v1, v4, v5, v2}, La/ac;->timeout(JLjava/util/concurrent/TimeUnit;)La/ac;

    .line 381
    iget-object v1, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/g;

    invoke-interface {v1}, La/g;->timeout()La/ac;
    ...
    .line 393
    :cond_0
    invoke-virtual {v0, v1, v2}, Lokhttp3/internal/http1/Http1Codec;->newFixedLengthSource(J)La/ab;
    ...
    invoke-static {v0, v1, v2}, Lokhttp3/internal/Util;->skipAll(La/ab;ILjava/util/concurrent/TimeUnit;)Z
    ...
    .line 403
    :cond_4
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->source:La/h;

    invoke-interface {p1}, La/h;->a()La/e;
    ...
    iget-object p1, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/g;

    invoke-interface {p1}, La/g;->a()La/e;
...
.method private startHttp2(I)V
    ...
    iget-object v3, p0, Lokhttp3/internal/connection/RealConnection;->source:La/h;

    iget-object v4, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/g;

    invoke-virtual {v0, v1, v2, v3, v4}, Lokhttp3/internal/http2/Http2Connection$Builder;->socket(Ljava/net/Socket;Ljava/lang/String;La/h;La/g;)Lokhttp3/internal/http2/Http2Connection$Builder;
...
.method public final connect(IIIIZLokhttp3/Call;Lokhttp3/EventListener;)V
    ...
    .line 177
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->source:La/h;

    .line 178
    iput-object v11, v7, Lokhttp3/internal/connection/RealConnection;->sink:La/g;
...
.method public final isHealthy(Z)Z
    ...
    .line 569
    iget-object v2, p0, Lokhttp3/internal/connection/RealConnection;->source:La/h;

    invoke-interface {v2}, La/h;->d()Z
...
.method public final newCodec(Lokhttp3/OkHttpClient;Lokhttp3/Interceptor$Chain;Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/http/HttpCodec;
    ...
    .line 527
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->source:La/h;
    ...
    invoke-virtual {v0, v1, v2, v3}, La/ac;->timeout(JLjava/util/concurrent/TimeUnit;)La/ac;

    .line 528
    iget-object v0, p0, Lokhttp3/internal/connection/RealConnection;->sink:La/g;

    invoke-interface {v0}, La/g;->timeout()La/ac;
    ...
    invoke-virtual {v0, v1, v2, p2}, La/ac;->timeout(JLjava/util/concurrent/TimeUnit;)La/ac;
    ...
    invoke-direct {p2, p1, p3, v0, v1}, Lokhttp3/internal/http1/Http1Codec;-><init>(Lokhttp3/OkHttpClient;Lokhttp3/internal/connection/StreamAllocation;La/h;La/g;)V
...
.method public final newWebSocketStreams(Lokhttp3/internal/connection/StreamAllocation;)Lokhttp3/internal/ws/RealWebSocket$Streams;
    ...
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/connection/RealConnection$1;-><init>(Lokhttp3/internal/connection/RealConnection;ZLa/h;La/g;Lokhttp3/internal/connection/StreamAllocation;)V
