...
.method constructor <init>(Lokhttp3/internal/http2/Http2Connection$Builder;)V
    ...
    iget-object v3, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->sink:La/g;

    iget-boolean v4, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Http2Writer;-><init>(La/g;Z)V
    ...
    iget-object v1, v1, Lokhttp3/internal/http2/Http2Connection$Builder;->source:La/h;

    iget-boolean v4, v0, Lokhttp3/internal/http2/Http2Connection;->client:Z

    invoke-direct {v3, v1, v4}, Lokhttp3/internal/http2/Http2Reader;-><init>(La/h;Z)V
...
.method final pushDataLater(ILa/h;IZ)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 963
    invoke-interface {p2, v0, v1}, La/h;->a(J)V

    .line 964
    invoke-interface {p2, v5, v0, v1}, La/h;->read(La/e;J)J

    .line 1067
    iget-wide v2, v5, La/e;->b:J
    ...
    invoke-direct/range {v0 .. v7}, Lokhttp3/internal/http2/Http2Connection$6;-><init>(Lokhttp3/internal/http2/Http2Connection;Ljava/lang/String;[Ljava/lang/Object;ILa/e;IZ)V
...
.method final sendDegradedPingLater()V
    .locals 6
...
.method public final writeData(IZLa/e;J)V
    .locals 8
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p4, p2, p1, p3, v0}, Lokhttp3/internal/http2/Http2Writer;->data(ZILa/e;I)V
    ...
    :goto_2
    invoke-virtual {v4, v5, p1, p3, v3}, Lokhttp3/internal/http2/Http2Writer;->data(ZILa/e;I)V
