...
# direct methods
.method constructor <init>(IZLa/e;)V
    .locals 1
    ...
    .line 404
    iput-object p3, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:La/e;
...
.method constructor <init>(La/e;)V
    ...
    .line 397
    invoke-direct {p0, v0, v1, p1}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLa/e;)V
...
.method final writeByteString(La/i;)V
    .locals 3
    ...
    invoke-virtual {v0, p1}, Lokhttp3/internal/http2/Huffman;->encodedLength(La/i;)I
    ...
    invoke-virtual {v2, p1, v0}, Lokhttp3/internal/http2/Huffman;->encode(La/i;La/g;)V
    ...
    .line 557
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:La/e;
...
.method final writeHeaders(Ljava/util/List;)V
    ...
    .line 473
    iget-object v4, v3, Lokhttp3/internal/http2/Header;->name:La/i;

    invoke-virtual {v4}, La/i;->g()La/i;

    move-result-object v4

    .line 474
    iget-object v5, v3, Lokhttp3/internal/http2/Header;->value:La/i;
    ...
    iget-object v9, v9, Lokhttp3/internal/http2/Header;->value:La/i;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->name:La/i;
    ...
    iget-object v11, v11, Lokhttp3/internal/http2/Header;->value:La/i;
    ...
    .line 512
    iget-object v7, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:La/e;

    invoke-virtual {v7, v6}, La/e;->b(I)La/e;

    .line 513
    invoke-virtual {p0, v4}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(La/i;)V

    .line 514
    invoke-virtual {p0, v5}, Lokhttp3/internal/http2/Hpack$Writer;->writeByteString(La/i;)V
    ...
    .line 516
    :cond_9
    sget-object v7, Lokhttp3/internal/http2/Header;->PSEUDO_PREFIX:La/i;

    invoke-virtual {v4, v7}, La/i;->a(La/i;)Z

    move-result v7

    if-eqz v7, :cond_a

    sget-object v7, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:La/i;

    invoke-virtual {v7, v4}, La/i;->equals(Ljava/lang/Object;)Z
...
.method final writeInt(III)V
    ...
    .line 534
    iget-object p2, p0, Lokhttp3/internal/http2/Hpack$Writer;->out:La/e;

    or-int/2addr p1, p3

    invoke-virtual {p2, p1}, La/e;->b(I)La/e;
    ...
    invoke-virtual {v0, p3}, La/e;->b(I)La/e;
    ...
    invoke-virtual {v0, p2}, La/e;->b(I)La/e;
