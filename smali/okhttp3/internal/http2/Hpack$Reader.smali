...
# direct methods
.method constructor <init>(IILa/ab;)V
    .locals 1
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:La/h;

    return-void
.end method

.method constructor <init>(ILa/ab;)V
    .locals 0

    .line 131
    invoke-direct {p0, p1, p1, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(IILa/ab;)V
...
.method private getName(I)La/i;
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:La/i;
...
.method private readByte()I
    ...
    .line 315
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:La/h;
...
.method private readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 250
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)La/i;

    move-result-object p1

    .line 251
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()La/i;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(La/i;La/i;)V
...
.method private readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-static {v0}, Lokhttp3/internal/http2/Hpack;->checkLowercase(La/i;)La/i;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(La/i;La/i;)V
...
.method private readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(La/i;La/i;)V
...
.method private readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(La/i;La/i;)V
...
.method final readByteString()La/i;
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v2, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:La/h;

    int-to-long v3, v0

    invoke-interface {v2, v3, v4}, La/h;->h(J)[B
    ...
    .line 349
    :cond_1
    iget-object v1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:La/h;

    int-to-long v2, v0

    invoke-interface {v1, v2, v3}, La/h;->d(J)La/i;
