...
.method constructor <init>(La/h;Z)V
    ...
    .line 71
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/h;
    ...
    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(La/h;)V
    ...
    invoke-direct {p1, v0, p2}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(ILa/ab;)V
...
.method private readData(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 211
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/h;
    ...
    .line 214
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/h;

    invoke-interface {p1, v1, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILa/h;I)V

    .line 215
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/h;

    int-to-long p2, v0

    invoke-interface {p1, p2, p3}, La/h;->i(J)V
...
.method private readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 319
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/h;

    invoke-interface {p4}, La/h;->i()I

    move-result p4

    .line 320
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/h;

    invoke-interface {v2}, La/h;->i()I
    ...
    invoke-interface {p3, v1, v2}, La/h;->d(J)La/i;

    move-result-object p3

    .line 330
    :cond_0
    invoke-interface {p1, p4, v0, p3}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;La/i;)V
...
.method static readMedium(La/h;)I
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method private readPing(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 309
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/h;

    invoke-interface {p2}, La/h;->i()I
...
.method private readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 229
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/h;

    invoke-interface {v3}, La/h;->g()B
...
.method private readPushPromise(Lokhttp3/internal/http2/Http2Reader$Handler;IBI)V
    ...
    .line 298
    :cond_0
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:La/h;

    invoke-interface {v1}, La/h;->i()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v1, v2, v3}, La/h;->a(J)V
    :try_end_0
    ...
    invoke-static {v1}, Lokhttp3/internal/http2/Http2Reader;->readMedium(La/h;)I
    ...
    invoke-interface {p1, v0, v1}, La/h;->i(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:La/i;
    ...
    invoke-interface {p1, v3, v4}, La/h;->d(J)La/i;
    ...
    .line 88
    invoke-virtual {p1}, La/i;->a()Ljava/lang/String;
