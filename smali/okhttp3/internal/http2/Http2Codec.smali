...
.method public static http2HeadersList(Lokhttp3/Request;)Ljava/util/List;
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_METHOD:La/i;

    invoke-virtual {p0}, Lokhttp3/Request;->method()Ljava/lang/String;

    move-result-object v4

    invoke-direct {v2, v3, v4}, Lokhttp3/internal/http2/Header;-><init>(La/i;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_PATH:La/i;
    ...
    sget-object v4, Lokhttp3/internal/http2/Header;->TARGET_AUTHORITY:La/i;

    invoke-direct {v3, v4, v2}, Lokhttp3/internal/http2/Header;-><init>(La/i;Ljava/lang/String;)V
    ...
    sget-object v3, Lokhttp3/internal/http2/Header;->TARGET_SCHEME:La/i;
    ...
    invoke-direct {v2, v3, p0}, Lokhttp3/internal/http2/Header;-><init>(La/i;Ljava/lang/String;)V
    ...
    invoke-static {v3}, La/i;->a(Ljava/lang/String;)La/i;
    ...
    invoke-direct {v4, v3, v5}, Lokhttp3/internal/http2/Header;-><init>(La/i;Ljava/lang/String;)V
...
.method public final createRequestBody(Lokhttp3/Request;J)La/aa;
    ...
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->getSink()La/aa;
...
.method public final finishRequest()V
    ...
    invoke-virtual {v0}, Lokhttp3/internal/http2/Http2Stream;->getSink()La/aa;
...
.method public final openResponseBody(Lokhttp3/Response;)Lokhttp3/ResponseBody;
    ...
    invoke-virtual {v3}, Lokhttp3/internal/http2/Http2Stream;->getSource()La/ab;

    move-result-object v3

    invoke-direct {p1, p0, v3}, Lokhttp3/internal/http2/Http2Codec$StreamFinishingSource;-><init>(Lokhttp3/internal/http2/Http2Codec;La/ab;)V
...
.method public final writeRequestHeaders(Lokhttp3/Request;)V
    ...
    .line 118
    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->readTimeout()La/ac;
    ...
    invoke-virtual {p1, v0, v1, v2}, La/ac;->timeout(JLjava/util/concurrent/TimeUnit;)La/ac;

    .line 119
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Codec;->stream:Lokhttp3/internal/http2/Http2Stream;

    invoke-virtual {p1}, Lokhttp3/internal/http2/Http2Stream;->writeTimeout()La/ac;
