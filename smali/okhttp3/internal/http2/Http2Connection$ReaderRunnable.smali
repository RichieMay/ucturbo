...
.method public alternateService(ILjava/lang/String;La/i;Ljava/lang/String;IJ)V
    .locals 0
...
.method public data(ZILa/h;I)V
    ...
    invoke-virtual {v0, p2, p3, p4, p1}, Lokhttp3/internal/http2/Http2Connection;->pushDataLater(ILa/h;IZ)V
    ...
    .line 704
    invoke-interface {p3, v0, v1}, La/h;->i(J)V

    return-void

    .line 707
    :cond_1
    invoke-virtual {v0, p3, p4}, Lokhttp3/internal/http2/Http2Stream;->receiveData(La/h;I)V
...
.method public goAway(ILokhttp3/internal/http2/ErrorCode;La/i;)V
    .locals 3

    .line 847
    invoke-virtual {p3}, La/i;->h()I
