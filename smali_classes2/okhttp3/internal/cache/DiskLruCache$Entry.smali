...
.method final snapshot()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-interface {v2, v3}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)La/ab;
    ...
    invoke-direct/range {v1 .. v7}, Lokhttp3/internal/cache/DiskLruCache$Snapshot;-><init>(Lokhttp3/internal/cache/DiskLruCache;Ljava/lang/String;J[La/ab;[J)V
    :try_end_0
...
.method final writeLengths(La/g;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 1012
    invoke-interface {p1, v5}, La/g;->h(I)La/g;

    move-result-object v5

    invoke-interface {v5, v3, v4}, La/g;->n(J)La/g;
